import { getAdminInfo_api, updateAdmin_api,getSubjectInfo_api,hideSubject_api
,getOneSubjectInfo_api,updateSubjectInfo_api,getMajorInfo_api,createSubjectInfo_api} from '../apis/Admin'
...
class AdminService {
    ...
    async hideSubject(subjecttID) {
        return axios_client.put(
            hideSubject_api(subjecttID),subjecttID,
            axios_config
        )
    }
    async getAllMajors() {
