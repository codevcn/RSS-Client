...
const SubjectList = () => {
    ...
    const loadSubjects = () => {
        adminService.getAllSubjectInfo()
            .then(response => {
                ...
                <tbody>
                    {subjects.map(subject => (
                        <tr key={subject.id}>
                            ...
                            <td>
                                <Button className="edit-button" onClick={() => updateSubject(subject.id)}>Chỉnh sửa</Button>
                                <Button className="hidden-button" onClick={() => hideSubject(subject.id)}>Ẩn</Button>
                            </td>
                        </tr>
                    ))}
                </tbody>
