            ...
            <div className="AdminInfo">
                {adminInfo && (
                    <div>
                        ...
                        <p>Username: <span>{adminInfo.account?.username}</span></p>
                        <p>idcard: <span>{adminInfo.idcard}</span></p>
                        <p>fullName: <span>{adminInfo.fullName}</span></p>
                        <p>birthday: <span>{adminInfo.birthday}</span></p>
                        <p>gender: <span>{adminInfo.gender}</span></p>
                    </div>
                )}
                <div>
