...
const AdminUpdate = ({ adminInfo, show, onHide }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (adminData.idcard !== adminInfo.idcard && Idcards.some((Id) => Id.Idcards === adminData.idcard)) {
        ...
        if (adminData.account?.username !== adminInfo.account?.username && username.some((user) => user.username === adminData.account?.username)) {
    ...
    return (
        <Modal className="AdminUpdate" show={show} onHide={onHide} centered>
            ...
            <Modal.Footer>
                <Button className='Cancel-save' variant="secondary" onClick={() => navigator('/admin/info')}>
                    Hủy
                </Button>
                ...
                {showConfirm && (
                    <Modal className='Confirm-form'show={true} onHide={handleCancel} centered>
                        ...
                        <Modal.Footer>
                            <Button className='Cancel-confirm' variant="secondary" onClick={handleCancel}>
                                Hủy
                            </Button>
